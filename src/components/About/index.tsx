    ...
    <section id="about" className={`section alt-bg ${styles.about}`} aria-label="About">
      <ScrollReveal className="sec-hd">
        ...
        <p className="sec-desc">
          Building durable frontend foundations and low-latency API wrappers to power enterprise web clients.
        </p>
      </ScrollReveal>
      ...
      <div className={styles.grid}>
        ...
        <ScrollReveal direction="right" className={styles.contentCol}>
          <div className={styles.text}>
            <p>
              I am a <strong>Senior Associate at Synechron Technologies</strong>, currently embedded as a frontend 
              lead at <strong>Emirates NBD</strong> in Dubai. I architect risk-modelling eligibility UIs and 
              credit configurations serving active retail operations across the UAE.
            </p>
            <p>
              My stack revolves around the **React.js ecosystem**—with a specific focus on structural optimization, 
              Redux state orchestration, performance budgeting, and custom native bridges. I design frontend 
              architectures that are modular, strictly typed, and easily maintainable.
            </p>
            <p>
              Over my career, I have worked across diverse industries including fintech (Emirates NBD), edtech 
              (Byju's Learn Portal), and EV mobility retail (Ola Electric checkout pipeline)—consistently delivering 
              scalable codebases and low-latency client apps.
            </p>
          </div>
          ...
          <div className={styles.callout}>
            ...
            <div>
              Currently leading frontend development for the <strong>Decision Management System (DMS)</strong>, 
              automating bank-wide risk-eligibility workflows under Synechron at Emirates NBD, Dubai.
            </div>
          </div>
